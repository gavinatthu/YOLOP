...
_C.DATASET.DATAROOT = '/data1/BDD100K/bdd100k/images/100k'       # the path of images folder
_C.DATASET.LABELROOT = '/data1/BDD100K/YOLOP/det_annotations'      # the path of det_annotations folder
_C.DATASET.MASKROOT = '/data1/BDD100K/YOLOP/bdd_seg_gt'                # the path of da_seg_annotations folder
_C.DATASET.LANEROOT = '/data1/BDD100K/YOLOP/bdd_lane_gt'               # the path of ll_seg_annotations folder
